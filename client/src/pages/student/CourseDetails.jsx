...
const CourseDetails = () => {
    ...
    const {allCourses, enrolledCourses, calculateRating, calculateNoOfLectures, 
    ...
    const isAlreadyEnrolled = enrolledCourses ? enrolledCourses.some(course => course._id === id) : false;
